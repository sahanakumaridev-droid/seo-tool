/** Per-route title, description, and share image for every static ZeOrbit URL. */

export const DEFAULT_OG_IMAGE = '/videos/hero-agency-poster.webp'

export const PAGE_SEO = {
  '/': {
    title: 'ZeOrbit — Websites, Mobile Apps & SEO for U.S. Businesses',
    description:
      'ZeOrbit builds WordPress, Shopify, Wix, and Squarespace websites plus iOS/Android apps. SEO, GEO, PPC, and Google Ads for U.S. brands. San Diego HQ.',
  ...
  '/mobile-apps': {
    ...
    image: '/from-zeorbit/portfolio/app-6.webp',
  },
  '/custom-software': {
    ...
    image: '/showcase/ai-ops-dark.webp',
  },
  '/seo-ppc': {
  ...
  '/portfolio': {
    ...
    image: '/showcase/work-mac-stone.webp',
  },
  '/privacy-policy': {
  ...
  '/revamp-preview': {
    title: 'Preview — ZeOrbit',
    description: 'Internal preview of the ZeOrbit homepage.',
    image: DEFAULT_OG_IMAGE,
