...
const SERVICE_OPTIONS = [
  { value: 'AI Solutions & AI Agents', label: 'AI Solutions' },
  ...
  { value: 'Data Processing & Analytics', label: 'Data & Analytics' },
]
    ...
    <div className="rv-contact-card" role="region" aria-label="Contact ZeOrbit">
      <div className="rv-contact-head">
        ...
        <p className="rv-contact-sub">
          AI, software, website, app, automation, or growth—we&apos;ll route your request to the right team.
        </p>
      </div>
