...
export default function RevampHeader() {
  ...
  return (
    <header ref={headerRef} className="zo-site-header is-solid">
      <div className="zo-navbar">
        <div className="zo-navbar-inner">
          <div className="zo-brand">
            ...
            <div className="zo-header-social" aria-label="Social media">
              {HEADER_SOCIAL.map((item) => (
                <a
                  ...
                  className="zo-header-social-link"
                >
