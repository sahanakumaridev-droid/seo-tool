...
PUBLIC_BASE = "https://seo.159.198.79.219.nip.io"
GSC_SITE = f"{PUBLIC_BASE}/"
SITEMAP = f"{PUBLIC_BASE}/sitemap.xml"
            ...
            try:
                ...
                if not email.endswith(".iam.gserviceaccount.com"):
                    ...
                    if not sc.is_configured():
                        ...
                        return 1
                    result = sc.submit_sitemap(SITEMAP)
                    print("SITEMAP_SUBMIT:", result)
                    print("SUCCESS: GSC wired. Restart backend, open Google Indexing in the app, click Push to Google.")
